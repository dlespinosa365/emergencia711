...
<div class="row">
    <div class="col-md-7">
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    <b>Nombre</b>
                    <p>{{ $historia->cliente->fullname }}</p>
                </div>
                <div class="col-md-12">
                    <b>Direccion</b>
                    <p>{{ $historia->cliente->FullDireccion }}</p>
                </div>
                <div class="col-md-12">
                    <b>{!! Form::label('motivo_consulta', 'Motivo de consulta')!!}</b>
                    <p> {!! Form::textarea('motivo_consulta' , old('motivo_consulta') ,['class' => 'form-control']) !!}</p>
                </div>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="row">
            ...
            <div class="col-md-12">
                <b>CI</b>
                <p>{{ $historia->cliente->cedula }}</p>
                <b>Tel</b>
                <p>{{ $historia->cliente->telefono }}</p>
            </div>
            <div class="col-md-12">
    ...
    <div class="col-md-2">
        <div class="row">
            ...
            <div class="col-md-12">
                <b>Edad</b>
                <p>{{ $historia->cliente->edad }}</p>
            </div>
            <div class="col-md-12">
                <b>Sexo</b>
                <p>{{ $historia->cliente->sexo }}</p>
            </div>
        </div>
